...
public class InputField extends JComponent implements KeyListener, FocusListener{
	public Color color1;
	public Color color2;
	public Color color3;
	...
	public InputField(String text, Color c1, Color c2, Color c3){
		this.text = text;
	...
	public InputField(String text, String message, Color c1, Color c2, Color c3){
		this(text, c1, c2, c3);
	...
	public void paint(Graphics graphics){
		...
		if(text == null || text.equals("")){
			g.drawString(display, getWidth()/2 - g.getFontMetrics().stringWidth(display)/2, getHeight()/2 - g.getFontMetrics().getHeight()/2 + g.getFontMetrics().getAscent() - g.getFontMetrics().getDescent() + 1);
		}
		else {
			if(!isFocusOwner())
				g.setColor(color3);
