...
import de.schemil053.ui.animation.AnimationLayer;
...
public class TextComponent extends JComponent{
	...
	public TextComponent(String text, Color color1, Color color2, Color color3, Runnable runnable){
		this.dir = text;
		this.color1 = color1;
		this.color2 = color2;
		this.color3 = color3;
		...
		addMouseListener(new MouseAdapter(){
			...
			public void mouseClicked(MouseEvent e){
				if(TextComponent.this.runnable != null && e.getButton() == 1)
					TextComponent.this.runnable.run();
			}
		});
	...
	public TextComponent(String text, String toolTip, Color color1, Color color2, Color color3, Runnable runnable) {
		this(text, color1, color2, color3, runnable);
		setToolTipText(toolTip);
	}
	
	public TextComponent(BufferedImage image, int width, int height, Color color1, Color color2, Color color3, Runnable runnable){
	...
	public TextComponent(BufferedImage image, Color color1, Color color2, Color color3, Runnable runnable){
		this("", color1, color2, color3, runnable);
		this.image = image;
		w = image.getWidth();
		h = image.getHeight();
	...
	public TextComponent(BufferedImage image, int width, int height, String toolTip, Color color1, Color color2, Color color3, Runnable runnable) {
	...
	public TextComponent(BufferedImage image, String toolTip, Color color1, Color color2, Color color3, Runnable runnable) {
		this("", toolTip, color1, color2, color3, runnable);
		this.image = image;
		w = image.getWidth();
		h = image.getHeight();
	...
	public void setGifImage(Image gifImage, int width, int height) {
	...
	public void setGradientColor(Color colorG) {
		this.colorG = colorG;
		repaint();
	}
